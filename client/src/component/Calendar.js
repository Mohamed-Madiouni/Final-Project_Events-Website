        ...
        {eventId && (
          ...
          >
            <div
              ...
              style={{ height: "59%", cursor: "pointer" }}
            >
              <img
                className="activator"
                src={allevents.find((e) => e._id === eventId).image}
                height="100%"
                alt=""
              />
              ...
              <div className="star_rate_cal right">
                ...
                >
                  {allevents.find((e) => e._id === eventId).rating.length === 0
                    ? "--"
                    : calcul_rating(
                        allevents.find((e) => e._id === eventId).rating
                      )}
                </p>
              </div>
              <div
            ...
            >
              ...
              >
                {allevents.find((e) => e._id === eventId).title.length <= 12 ? (
                  <b>{allevents.find((e) => e._id === eventId).title}</b>
                ) : (
                  <marquee scrolldelay={140} behavior="scroll" direction="left">
                    <b>{allevents.find((e) => e._id === eventId).title}</b>
                  </marquee>
                )}
              </span>
              {allevents.find((e) => e._id === eventId).address.address.length <=
              18 ? (
                <p className="red-text address_map">
                  <i className="fas fa-home" style={{ marginRight: 5 }}></i>
                  {allevents.find((e) => e._id === eventId).address.address}
                </p>
              ) : (
              ...
              >
                ...
                >
                  ...
                  {historyevent(
                    allevents.find((e) => e._id === eventId).created_at
                  )}
                </span>
                <span
                  style={{
                ...
                >
                  ...
                  {allevents.find((e) => e._id === eventId).participant.length +
                    "/" +
            ...
            >
              {!auth.isAuthenticated
                ...
                : auth.user.role === "participant" &&
                  !auth.user.cancelation.includes(
                    allevents.find((e) => e._id === eventId)._id
                  ) &&
                    ...
                    : allevents.find((e) => e._id === eventId).state !==
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            setEventDate(
                              allevents.find((e) => e._id === eventId).start
                            );
                            // :dispatch(unfollowEvent(el._id))
                          }}
                          style={{
            ...
            >
              ...
              <p style={{ fontSize: 13, color: "rgb(0, 96, 100)" }}>
                {formatRelative(
                  new Date(allevents.find((e) => e._id === eventId).start),
                  new Date()
                ) +
                  " - " +
                  formatRelative(
                    new Date(allevents.find((e) => e._id === eventId).end),
                    new Date()
                  )}
              </p>
              <p style={{ lineHeight: "normal" }}>
                {allevents.find((e) => e._id === eventId).description}
              </p>
              <div
                className="right"
                style={{
              ...
              >
                ...
                href="#!"
                  ...
                  onClick={() => {
                    history.push(
                      `/events/${allevents.find((e) => e._id === eventId)._id}`
                    );
                  }}
                  title="Show comments"
                >
