...
function Updateacc({ history }) {
  ...
  useEffect(() => {
    if (
      ...
      new Date(eventClosing(userban.created_at, userban.duration)) > new Date()
    ) {
      dispatch(logoutUser());
      history.push("/banned");
    }
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="row"
          style={{ backgroundColor: "white", filter: mod && "brightness(30%)" }}
        >
          <div className="col s8 m7 offset-m2">
            ...
            <form encType="multipart/form-data">
              ...
              <div className="input-field col s12">
                ...
                />
                <label htmlFor="note">
                  Enter a note to be displayed for other users
                </label>
                <span className={user.error.note ? "red-text" : "green-text"}>
                  {user.error.note ||
                    (auth.user.note && "Your note is: " + auth.user.note)}
                </span>
              </div>
              <div
                className="col s12"
      ...
      <div
        className="custom_mod"
        style={{ display: mod ? "initial" : "none", padding: "10px" }}
      >
        <div className="modal-content">
          ...
          <div className="input-field col s12" style={{ marginTop: "20px" }}>
            ...
            <span
              onClick={() => {
                if (passcontype === "password") setpasscontype("text");
                else setpasscontype("password");
              }}
              style={{
                position: "absolute",
                right: 14,
              ...
              title={
                passcontype === "password" ? "Show password" : "Hide password"
              }
            >
