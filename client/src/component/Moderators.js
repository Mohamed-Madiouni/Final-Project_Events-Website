...
const Moderators = () => {
  ...
  return (
    <div id="modalmodo" style={{ padding: 0, margin:0 }}>
            <div>
              <h4 className="center" style={{ marginTop: "20px" }}>Moderators Center</h4>
            </div>
...
{(quickSearch.fname!="" || quickSearch.lname!="" || quickSearch.role!="" || quickSearch.address!="" || quickSearch.tel!="" || quickSearch.email!="")&&            
            <div className="row" style={{marginLeft:"10px", marginBottom: "0px"}} > 
              <div className=" row vc_row wpb_row vc_row-fluid section-header featured" style={{ marginBottom: "0px"}}>
