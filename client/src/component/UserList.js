...
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    <div>
      ...
      >
        <h5 style={{ position: "absolute", fontSize: 30, left: 5, top: -30 }}>
          <b>Looking for a user?</b>
        </h5>
        <div className="col s12">
          ...
          >
            <p>
              Select a user name or choose an address or email to find the one
              looking for.
            </p>
          </div>
          <div
      ...
      <div id="modal2" className="modal">
        <div className="modal-content">
          ...
          <label htmlFor="sel1">Duration</label>
          <p />
          <select
            id="sel1"
            id="duration"
          ...
          >
            ...
            <option value="8">8 Days</option>+ <option value="9">9 Days</option>
