          ...
          <div
            ...
            onClick={(e) => {
              ...
              sort &&
                ...
                setsort(!sort);
              unfollow &&
                !document.querySelector(".custom_mod").contains(e.target) &&
                setunfollow("");
            }}
          >
              ...
              <div className="comment_sec">
                ...
                <div style={{ position: "relative" }}>
                  <p className="comment">
                    ...
                    {comments.comments &&
                      nbr_comments(
                        comments.comments.filter((el) => el.reports > 0).length
                      ) +
                        rs +
                        " "}
                    Reported comment
                            ...
                            >
                              {(el.postedBy === auth.user._id ||
                                ...
                                <div id="editdelete">
                                  ...
                                  <i
                                    onClick={() => setRemovereport(el._id)}
                                    className="modal-trigger count"
                                    data-target="modaldeletreportcom"
                                    title="Remove Report"
                                  >
                                    <span
                                      className="num"
                                      style={{ top: "5px", left: "9px" }}
                                    >
                                      {el.reports}
                                    </span>
                                  </i>
                                  ...
                                  >
                                    {(el.postedBy === auth.user._id ||
                                      ...
                                      <div id="editdelete">
                                        ...
                                        <i
                                          onClick={() => setRemovereport(el.id)}
                                          className="modal-trigger count"
                                          data-target="modaldeletreportreply"
                                          title="Remove Report"
                                        >
                                          <span
                                            className="num"
                                  ...
                                  >
                                    <i
                                      ...
                                      style={{
                                        ...
                                        color:
                                          auth.isAuthenticated &&
                                          auth.user.likes.includes(el.id) &&
                                          "#2e8fa5",
                                      }}
                                      onClick={() => {
                                        if (actvlike) {
                                    ...
                                    <i
                                      ...
                                      style={{
                                        color:
                                          auth.isAuthenticated &&
                                          auth.user.dislikes.includes(el.id) &&
                                          "#2e8fa5",
                                      }}
                                      onClick={() => {
                                        if (actvlike) {
