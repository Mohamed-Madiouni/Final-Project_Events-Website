  ...
  return (
    ...
    >
      <div className="test row">
        <div
          className={!resize.state ? "div2 col s10 row" : "div3 col s6 m8 row"}
        >
          <div
            style={{
              padding: "0px",
          ...
          <div
            className={!resize.state ? "div4 col s10 row" : " div5 col s2"}
            style={{ margin: 0 }}
          >
            {!resize.state ? (
              <>
                <div
                  className="col s11 nav_list "
                  style={{
                    display: "flex",
...
//             <Link to="/calendar" style={{color:location.pathname==="/calendar"&&"rgb(14, 161, 152)"}}>Calendar</Link> */}
        ...
        <div
          className={!resize.state ? " landing col s2" : "landing col s6 m4"}
          style={{
            margin: 0,
          }}
        >
