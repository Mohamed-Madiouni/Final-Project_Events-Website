...
function Searchevents() {
  ...
  function onSubmit(e) {
    ...
    history.push(
      `/search?title=${eventsearch.title}&address=${eventsearch.address}&description=${eventsearch.description}`
    );
  }
  // else
  // setErrorsearch(true)
        ...
        <div className="col s10 ">
          {!search.search ? (
            ...
            <form className="col s12" onSubmit={onSubmit}>
              ...
              <span className="col s12 red-text">
                {errorsearch && "At least one field required"}
              </span>
              <div
                className="col s12"
                style={{
