  ...
  return (
    <div
      ...
      onClick={(e) => {
        ...
        showchat &&
          !document.querySelector(".chatmodal").contains(e.target) &&
          dispatch({
            type: SHOW_CHAT,
            payload: !showchat,
          });
        chat.talk.show &&
          !(
            document.querySelector(".discumodal").contains(e.target) ||
            document.querySelector(".chatmodal").contains(e.target)
          ) &&
          dispatch({
            type: SHOW_TALK,
        ...
        <div className="App_center">
          ...
          {auth.isAuthenticated && (
            <div className="chatlist">
              ...
              <div
                className="chatmodal groupofnotes scrollbar"
                id="style-3"
                style={{ width: showchat ? 300 : 0 }}
              >
                <div
                  style={{
                    transition: "all 0.5s",
                ...
                >
                  <p
                    style={{
                      transition: "all 0.5s",
                      color: chatstate === "discussion" && "#2e8fa5",
                      textDecorationLine:
                        chatstate === "discussion" && "underline",
                      width: "100%",
                      textAlign: "center",
                      borderRight: "1px solid rgb(63, 63, 63)",
                      cursor: "pointer",
                    }}
                    onClick={() => setchatstate("discussion")}
                  >
                    Discussion
                  </p>
                  <p
                    style={{
                      transition: "all 0.5s",
                      color: chatstate === "block" && "#2e8fa5",
                      textDecorationLine: chatstate === "block" && "underline",
                      width: "100%",
                      textAlign: "center",
                      cursor: "pointer",
                    }}
                    onClick={() => setchatstate("block")}
                  >
                    Block list
                  </p>
                </div>
                {chatstate === "discussion" ? (
                  chat.discussion.filter((el) =>
                    el.users.includes(auth.user._id)
                  ).length === 0 ? (
                    <div
                      style={{
                        height: 457,
                    ...
                    <ul className="collection livechat">
                      {chat.discussion
                        .filter((el) => el.users.includes(auth.user._id))
                        .slice(0)
                        .sort((a, b) => {
                              ...
                              >
                                <img
                                  src={
                                    users.find(
                                      (elm) =>
                                        elm._id ===
                                        chatuser(el.users, auth.user._id)
                                    ).avatar
                                  }
                                  alt=""
                                  className="circle"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <span
                                      style={{ color: "#2e8fa5", fontSize: 11 }}
                                    >
                                      {historyevent(
                                        el.discussion[el.discussion.length - 1]
                                          .created_at
                                      )}
                                    </span>
                                  </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <b>
                                  {users.find((elm) => elm._id === el).fname +
                                    " " +
                                    users.find((elm) => elm._id === el).lname}
                                </b>
                              </span>
                            </div>
                            <i
