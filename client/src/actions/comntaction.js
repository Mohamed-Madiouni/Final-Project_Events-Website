...
//remove like
export const removelikecomment = (coment_id, nb_likes, userid) => (
  dispatch
) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/like/remove/${coment_id}`, {
      likes: nb_likes,
      user: userid,
    })
    .then((res) => {
...
export const dislikecomment = (coment_id, nb_likes, userid) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/dislike/${coment_id}`, {
      dislikes: nb_likes,
      user: userid,
    })
    .then((res) => {
...
//remove dislike
export const removedislikecomment = (coment_id, nb_likes, userid) => (
  dispatch
) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/dislike/remove/${coment_id}`, {
      dislikes: nb_likes,
      user: userid,
    })
    .then((res) => {
...
export const addreply = (content, coment_id, userId, idreply) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/reply/${coment_id}`, {
      content: content,
      postedBy: userId,
      created_at: new Date(),
      id: idreply,
...
export const likereply = (reply_id, nb_likes, userid) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/like/reply/${reply_id}`, {
      likes: nb_likes,
      user: userid,
    })
    .then((res) => {
...
export const removelikereply = (reply_id, nb_likes, userid) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/like/reply/remove/${reply_id}`, {
      likes: nb_likes,
      user: userid,
    })
    .then((res) => {
...
export const dislikereply = (reply_id, nb_likes, userid) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/dislike/reply/${reply_id}`, {
      dislikes: nb_likes,
      user: userid,
    })
    .then((res) => {
...
//remove dislikereply
export const removedislikereply = (reply_id, nb_likes, userid) => (
  dispatch
) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/dislike/reply/remove/${reply_id}`, {
      dislikes: nb_likes,
      user: userid,
    })
    .then((res) => {
...
export const editReply = (idReply, updatedComment) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/edit/reply/${idReply}`, {
...
export const reportComment = (coment_id, nb_reports, userid) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/comment/report/${coment_id}`, {
      reports: nb_reports,
      user: userid,
    })
    .then((res) => {
...
//report reply
export const reportReply = (reply_id, nb_reports, userid, comment_id) => (
  dispatch
) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/add/reply/report/${reply_id}`, {
      reports: nb_reports,
      user: userid,
      comment: comment_id,
    })
...
export const removereportComment = (coment_id, nb_reports) => (dispatch) => {
  setAuthToken(localStorage.token);
  axios
    .put(`/comment/remove/comment/report/${coment_id}`, { reports: nb_reports })
    .then((res) => {
      dispatch(getComment());
      dispatch(getCurrentUser());
      dispatch({
